...
def run_synchronous():
    ...
    print(f"  - Test Accuracy: {test_perf.get('accuracy', 'N/A'):.4f}" if isinstance(test_perf.get('accuracy'), float) else f"  - Test Accuracy: {test_perf.get('accuracy', 'N/A')}")
    print(f"  - Test F1 Score: {test_perf.get('f1', 'N/A'):.4f}" if isinstance(test_perf.get('f1'), float) else f"  - Test F1 Score: {test_perf.get('f1', 'N/A')}")
