...
**Module:** [`flowerpower.flowerpower`](src/flowerpower/flowerpower.py)
...
| `fs` | `AbstractFileSystem \| None` | An fsspec-compatible filesystem instance to use for file operations. | `None` |
