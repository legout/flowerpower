...
class FlowerPowerProject:
    ...
    def run(
        ...
        if name.strip() != name:
            raise ValueError("Pipeline 'name' cannot have leading or trailing whitespace")
    ...
    def start_worker_pool(
        ...
        **kwargs: Any,
        ...
        # Validate optional arguments
        if num_workers is not None and (not isinstance(num_workers, int) or num_workers <= 0):
